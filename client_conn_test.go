...
func Test_clientTCPConnWithSoftDeadline_Read(t *testing.T) {
	t.Run("ok", func(t *testing.T) {
		...
		mockedConn.On("Read", providedB).Return(expectedN, anError).Once()
	...
	t.Run("set deadline failed", func(t *testing.T) {
		...
		mockedConn.Test(t)
		t.Cleanup(func() { mockedConn.AssertExpectations(t) })
		mockedConn.On("SetReadDeadline", mock.Anything).Return(anError).Once()
...
func Test_clientTCPConnWithSoftDeadline_Write(t *testing.T) {
	t.Run("ok", func(t *testing.T) {
		...
		mockedConn.On("Write", providedB).Return(expectedN, anError).Once()
	...
	t.Run("set deadline failed", func(t *testing.T) {
		...
		mockedConn.On("SetWriteDeadline", mock.Anything).Return(anError).Once()
